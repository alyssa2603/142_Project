...
void initialize_labels (GRAPH *G, int source, NODE_LABEL* graph_label){
    
    
    for(int i =0; i< G->num_vertices; i++)
    {
        graph_label[i].labels = NULL;
        graph_label[i].treated=NULL; //T_i
        graph_label[i].untreated=NULL; //I_i
        graph_label[i].label_count = 0;
        graph_label[i].untreated_count = 0;
        graph_label[i].treated_count = 0;
    }

    graph_label[source].labels[0].length = 0;
    graph_label[source].labels[0].weight = 0;
    graph_label[source].label_count = 1;
}

bool is_dominated(int weight1, int weight2, int cost1, int cost2)
{
